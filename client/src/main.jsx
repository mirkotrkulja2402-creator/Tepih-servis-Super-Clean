...
function Login({onLogin}){
  ...
  const css=`
    ...
    .superclean-login-footer-text,
    .superclean-login-version{
      display:none;
    }
  ...
  return <>
    ...
    <div className="superclean-login-page">
      ...
      <div className="superclean-login-top">
        <img
          className="superclean-login-logo"
          src="/assets/logo.png"
      ...
      <div className="superclean-login-card">
        ...
        <div className="superclean-login-kicker">
          TEPIH SERVIS SUPER CLEAN
        </div>

        <h1 className="superclean-login-title">
          Dobro došli!
        </h1>

        <p className="superclean-login-subtitle">
        ...
        <div className="superclean-login-field">
          ...
          <input
            className="superclean-login-input"
        ...
        <div className="superclean-login-field">
          ...
          <button
            type="button"
            className="superclean-login-eye"
        ...
        <button
          type="button"
          className="superclean-login-button"
          onClick={onLogin}
        >
          <LogIn size={34}/>
          Prijava
        ...
        <label className="superclean-login-remember">
          <input
            className="superclean-login-check"
            type="checkbox"
            checked={remember}
        ...
        <div className="superclean-login-footer">
          <span className="superclean-login-footer-text">
            Tepih servis Super Clean
          </span>
          <span className="superclean-login-version">
            v1.0
          </span>
        </div>
      ...
      <div className="superclean-login-slogan">
